...
export const ActionPanel: React.FC<ActionPanelProps> = ({ onRunAnalysis, onReset }) => {
  return (
    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 px-4 sm:px-6 py-3 sm:py-4 bg-white/60 backdrop-blur-xl border-t border-white/30">
      {/* BUTTON GROUP */}
      <div className="grid grid-cols-2 gap-3 w-full sm:w-auto sm:min-w-[260px]">
        ...
        <button
          ...
          className="h-10 flex items-center justify-center gap-2 rounded-xl bg-blue-600 text-white text-sm font-medium shadow-[0_4px_12px_rgba(37,99,235,0.3)] hover:bg-blue-700 active:scale-[0.97] transition-all duration-200"
        >
